# -*- coding: utf-8 -*-
__author__ = 'alexdzul'
__modificated_by__ == 'bryandario8'
...
APPS_FOLDER = "apps/catalogue"  # <- Ruta de nuestra carpeta contenedora de apps
...
def user_yes_no_query():
    ...
    while True:
        try:
            respuesta = True #strtobool(raw_input().lower())
            if respuesta:
